        ...
        <div className="mx-auto grid max-w-7xl items-center gap-12 px-5 md:grid-cols-2">
          ...
          <div>
            ...
            <p className="mt-6 leading-loose text-muted-foreground">
              過膩了單打獨鬥日復一日的日子，「生態圈」是嶄新的未來。我們打破傳統商業與固有生存模式，透過吃喝玩樂．學習．互助共贏．一起做好事．一起變美變健康，搭配一套完善系統一起變美變健康創【造被動收入】，終結生活的孤島與重蹈覆轍的死循環； 結合多位頂尖企業家與跨界領袖，打造全維度生命共同體， 實現商業賦能、跨界媒合、生命覺醒與大愛傳承。
            </p>
