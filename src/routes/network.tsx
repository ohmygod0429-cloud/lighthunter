...
const cards = [
  {
    icon: Award,
    title: "引薦合格人才 現拿 $12,000",
    text: "每成功引薦一位符合資格的人才加入獵光者未來俱樂部共創未來，提成獎勵即時發放。你的人脈第一次有了明確的市場價格。",
  ...
  },
  {
    ...
    points: ["需求導向配對", "跨界資源直接變現", "僅限合法合規項目"],
  },
  {
    icon: UserSearch,
    title: "企業精準獵才",
     text: "會員企業可免費媒合獵光者未來俱樂部人才，從高階經理人到專業職能，用同頻文化篩選出真正合適的人。",
