      ...
      <div className="mt-24">
        ...
        <div className="mt-10 grid gap-6 md:grid-cols-3">
          {[
            ...
            { icon: "🎓", title: "資深導師名師授課$1999", text: "我們邀請的不是普通老師，而是實戰贏家。用共生共贏的機制，讓孩子與您直接站在巨人的肩膀上。" },
            { icon: "📈", title: "世襲式複利累積", text: "傳統教育花錢買心安，獵光者未來俱樂部買的是「世襲數位資產」。與上帝喝咖啡，您留給子孫的是一個龐大、自動運轉的智庫與人脈金庫。" },
          ].map((c) => (
