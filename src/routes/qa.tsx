...
const faqs: QA[] = [
  {
    ...
    a: (
      <div className="space-y-4">
        ...
        <p>
          而「獵光者生態圈」買的不是短暫的服務，而是「家族數位資產」。我們結合了全球商業媒合、跨世代智庫、真愛互助與永續網店。這是一套讓你的子孫三代「侵泡在愛裡、自動運轉的財富與智慧防護網」。
        </p>
      </div>
    ),
  },
  ...
  {
    q: "Q3：生態圈強調的「30 年世襲」到底是什麼意思？真的能傳給下一代嗎？",
    a: (
      <div className="space-y-4">
        ...
        <p>
          而在生態圈中，你獲得的是一整套「數位資產護照與永續網店經營權」。30 年後，當別人家的孩子還要背負學貸、重頭摸索社會時，你的孩子可以直接「一鍵接手」這個運作成熟的智庫、全球商業信用池與自動化金庫。
        </p>
      </div>
    ),
  },
