...
export const dimensions: Dimension[] = [
  ...
  },
  {
    ...
    title: "身心靈成長",
    tagline: "連結高能量顯化",
    detail: "在九紫離火運的時代，先照亮自己。活出喜悅、健康與內在豐盛，事業才會長久，財富才會亨通。",
