...
export const dimensions: Dimension[] = [
  ...
  },
  {
    ...
    title: "身心靈成長",
    tagline: "連結高能量顯化",
    detail: "在九紫離火運的時代，先照亮自己。活出喜悅、健康與內在豐盛，事業才會長久。",
  ...
  },
  {
    ...
    title: "全類別賦能課程",
    tagline: "頂尖大師終身引路",
    detail: "AI、自媒體、身心靈、行銷、品牌與管理、才藝、音樂，每月 20 堂以上，終身免費。",
  ...
  },
  {
    ...
    title: "極致吃喝玩樂",
    tagline: "尊榮私人聚會",
    detail: "以不同活動主題找到興趣相投、喜好相近的朋友，把品味與人脈一起養成。",
...
export const painPoints = [
  ...
  {
    title: "九紫離火運的時代孤獨",
    text: "少子化與人口老化交疊，人們越來越孤獨、越來越缺愛、越來越迷茫，需要的是一個共同體。",
  },
];

export const compareRows = [
  { label: "入會費用", legacy: "年費 $25,000 ~ $45,000，每年續繳", eco: "一次性終生會員 $79,500（可分 36 期）" },
  { label: "五年總花費", legacy: "含應酬餐費，五年花費破 $300,000", eco: "終生免續費，第二年起零成本" },
  { label: "課程資源", legacy: "多為額外付費或零散講座", eco: "每月 20 堂以上免費課程，涵蓋八大維度" },
  { label: "引薦機制", legacy: "無獎勵的義務引薦", eco: "介紹符合資格的資源人才，現拿 $12,000 提成獎勵" },
  { label: "人才招募", legacy: "自行付費委託獵頭", eco: "免費企業人才精準媒合與精準獵才" },
