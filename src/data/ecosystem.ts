...
export const dimensions: Dimension[] = [
  ...
  },
  {
    ...
    detail:
      "傳統旅行社行程零散、為湊景點拉車數小時，甚至安排強制購物站，讓出國渡假比上班還累。獵光者俱樂部摒棄傳統跟團模式，依會員的「年齡層」與「偏好主題」進行專屬深度訂製，讓旅遊成為一場身心沉浸與高品質社交。",
    points: [
  ...
  },
  {
    ...
    detail:
      "透過全球真愛生態圈內各板塊互相導流與收益共享機制，讓會員不僅能安心學習、有效拓展人脈，還能與同頻人深度連結找到志同道合的朋友，更能建立可持續的被動收益流。",
...
export const compareRows = [
  ...
  { label: "課程資源", legacy: "多為額外付費或零散講座", eco: "每月 20 堂以上名師課程只要$1999，涵蓋八大維度" },
  { label: "引薦機制", legacy: "無獎勵的義務引薦", eco: "引薦符合資格的人才參與生態圈共創未來，發放 $14400獎勵" },
